...
mqtt_config = MQTTConfig(
    host="c9ad72fd2aa34c84857753c4437ad26f.s1.eu.hivemq.cloud",  # Ganti dengan Host Cluster HiveMQ Cloud kamu
    port=8883,                                # Port standar SSL/TLS
    username="tara-device",             # Username yang dibuat di HiveMQ Cloud
    password="xohhyf-tuzFud-ryzdo41",         # Password yang dibuat di HiveMQ Cloud
